# Generated by Django 4.2 on 2025-02-08 16:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('athlete', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cycles', to='cycle_tracker.athlete')),
            ],
        ),
    ]
